...
class MakoMiddlewareTest(TestCase):
    ...
    def test_render_to_string_when_no_global_context_lms(self, context_mock):
        ...
        with patch("openedx.core.djangoapps.theming.helpers.get_current_site", return_value=None):
            with patch("openedx.core.djangoapps.theming.helpers.get_current_site_theme_dir", return_value=None):
    ...
    def test_render_to_string_when_no_global_context_cms(self, context_mock):
        ...
        with patch("openedx.core.djangoapps.theming.helpers.get_current_site", return_value=None):
            with patch("openedx.core.djangoapps.theming.helpers.get_current_site_theme_dir", return_value=None):
                del context_mock.context
                self.assertIn(
                    "We're having trouble rendering your component", render_to_string("html_error.html", None),
                )
