...
def get_current_site_theme_dir():
    ...
    # if comprehensive theming is enabled then return site theme dir.
    if site_theme and is_comprehensive_theming_enabled():
        site_theme_dir = getattr(site_theme, "theme_dir_name", None)
