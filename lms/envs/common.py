...
MIDDLEWARE_CLASSES = (
    ...
    # site theme middleware, this must come after CurrentSiteWithDefaultMiddleware and MicrositeMiddleware
    'openedx.core.djangoapps.theming.middleware.SiteThemeMiddleware',
